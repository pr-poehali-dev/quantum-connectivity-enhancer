const milestones = [
  { year: '1987', text: 'Начало пути в йоге — группа ШЙГАС, Днепропетровск' },
  { year: '1999', text: 'Квалификация «Инструктор Хатха-йоги» — Пермская школа' },
  { year: '2000', text: 'Куратор Пермской школы йоги в Томске, начало преподавания' },
  { year: '2005', text: 'Томский государственный университет — факультет психологии' },
  { year: '2009', text: 'Заведующий кафедрой Духовной навигации ИЙГАС, Москва' },
  { year: '2018', text: 'Тренер-преподаватель по парапланерному спорту' },
  { year: '2022', text: 'Квалификация «Практический психолог» — РГППУ, Екатеринбург' },
];
